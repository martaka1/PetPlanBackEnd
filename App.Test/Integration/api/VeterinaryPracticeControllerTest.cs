...
public class VpControllerTest : IClassFixture<CustomWebApplicationFactory<ProgramForTesting>>
{
    private readonly HttpClient _client;
    private readonly CustomWebApplicationFactory<ProgramForTesting> _factory;

    public VpControllerTest(CustomWebApplicationFactory<ProgramForTesting> factory)
    {
        _factory = factory;
